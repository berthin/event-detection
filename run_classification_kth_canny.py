...
PATH_KTH_PATTERNS = '/home/berthin/Documents/kth-visual_rhythm-horizontal-improved-patterns/'
...
'cells_per_block':(cells_per_block[0],cells_per_block[1]), 'visualise':False}

(data_training, data_validation, data_testing, label_training,
        label_validation, label_testing) =
...
kth_opticalFlow.run_svm_canny_patterns(data_training, data_validation,
        data_testing, label_training, label_validation, label_testing,
        type_svm)
